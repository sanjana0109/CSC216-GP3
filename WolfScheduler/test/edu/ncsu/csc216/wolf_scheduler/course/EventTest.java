...
public class EventTest {
	...
	public void testEvent() {
		...
		Event event = null;
		try {
			event = new Event(null, EVENT_MEETING_DAYS, EVENT_START_TIME, EVENT_END_TIME, EVENT_WEEKLY_REPEAT,
					EVENT_DETAILS);
			fail();
		...
		try {
			event = new Event("", EVENT_MEETING_DAYS, EVENT_START_TIME, EVENT_END_TIME, EVENT_WEEKLY_REPEAT,
					EVENT_DETAILS);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(event);
		...
		try {
			event = new Event(EVENT_TITLE, EVENT_MEETING_DAYS, 1897, EVENT_END_TIME, EVENT_WEEKLY_REPEAT,
					EVENT_DETAILS);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(event);
		...
		try {
			event = new Event(EVENT_TITLE, EVENT_MEETING_DAYS, EVENT_START_TIME, 997, EVENT_WEEKLY_REPEAT,
					EVENT_DETAILS);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(event);
		...
		try {
			event = new Event(EVENT_TITLE, EVENT_MEETING_DAYS, EVENT_START_TIME, 90, EVENT_WEEKLY_REPEAT,
					EVENT_DETAILS);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(event);
		...
		try {
			event = new Event(EVENT_TITLE, EVENT_MEETING_DAYS, EVENT_START_TIME, EVENT_END_TIME, EVENT_WEEKLY_REPEAT,
					null);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(event);
	...
	public void testSetMeetingDays() {
		Event event = new Event(EVENT_TITLE, EVENT_MEETING_DAYS, EVENT_START_TIME, EVENT_END_TIME, EVENT_WEEKLY_REPEAT,
				EVENT_DETAILS);
		try {
	...
	public void testToString() {
		...
		assertEquals(EVENT_TITLE + "," + EVENT_MEETING_DAYS + "," + EVENT_START_TIME + "," + EVENT_END_TIME + ","
				+ EVENT_WEEKLY_REPEAT + "," + EVENT_DETAILS, event.toString());
	}
	...
	public void testEqualsObject() {
		Activity e1 = new Event(EVENT_TITLE, EVENT_MEETING_DAYS, EVENT_START_TIME, EVENT_END_TIME, EVENT_WEEKLY_REPEAT,
				EVENT_DETAILS);
		Activity e2 = new Event(EVENT_TITLE, EVENT_MEETING_DAYS, EVENT_START_TIME, EVENT_END_TIME, EVENT_WEEKLY_REPEAT,
				EVENT_DETAILS);
		Activity e3 = new Event("Title", EVENT_MEETING_DAYS, EVENT_START_TIME, EVENT_END_TIME, EVENT_WEEKLY_REPEAT,
				EVENT_DETAILS);
		Activity e4 = new Event(EVENT_TITLE, "MWF", EVENT_START_TIME, EVENT_END_TIME, EVENT_WEEKLY_REPEAT,
				EVENT_DETAILS);
		Activity e5 = new Event(EVENT_TITLE, EVENT_MEETING_DAYS, 830, EVENT_END_TIME, EVENT_WEEKLY_REPEAT,
				EVENT_DETAILS);
		Activity e6 = new Event(EVENT_TITLE, EVENT_MEETING_DAYS, EVENT_START_TIME, 930, EVENT_WEEKLY_REPEAT,
				EVENT_DETAILS);
		Activity e7 = new Event(EVENT_TITLE, EVENT_MEETING_DAYS, EVENT_START_TIME, EVENT_END_TIME, 3, EVENT_DETAILS);
		Activity e8 = new Event(EVENT_TITLE, EVENT_MEETING_DAYS, EVENT_START_TIME, EVENT_END_TIME, EVENT_WEEKLY_REPEAT,
				"Details");
